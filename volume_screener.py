...
default_tickers = "RXT, RBRK, NOK, PATH, CBRS, SPCX, SOFI, META, GOOGL, RDDT, MU, NVDA, MSFT, AAPL, AMD, AMZN, SNDK, MRAM, GSIT, CRWV, IREN, WULF, VNET, AMBA, FLEX, BEP, TSLA, ONDS, RKLB, NBIS, ARM, MRVL, SPY, QQQ, IWM, COHR, LITE, SNPS, CLS, ALAB"
